...
Params->PARS[9] = 50.0;											//CK//  the number of exposed classes.  adjustable and fit.

Params->PARS[10] = 0.002;		//ck// ratio for virus infection.  Trying to set it and see what happens

Params->PARS[8] = 5;			Params->PARS[9] = 5;			// gamma steps (the number of exposed classes for virus and fungus)
